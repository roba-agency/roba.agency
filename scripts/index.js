document.addEventListener("DOMContentLoaded", (event) => {
    ...
    let card2to3Animation = gsap.timeline({
        scrollTrigger: {
            trigger: '.home-card3',
            start: 'center center+=622',
            scrub: 1,
    ...
    let card3to4Animation = gsap.timeline({
        scrollTrigger: {
            trigger: '.home-card4',
            start: 'center center+=622',
            scrub: 1,
    ...
    //card 4
    let card4Animation = gsap.timeline({
        scrollTrigger: {
            trigger: '.home-card4',
            pin: true,
            start: 'center center+=33',
    ...
    let card4to5Animation = gsap.timeline({
        scrollTrigger: {
            trigger: '.home-card5',
            start: 'center center+=622',
            scrub: 1,
    ...
    let card5Animation = gsap.timeline({
        scrollTrigger: {
            trigger: '.home-card5',
            pin: true,
            start: 'center center+=33',
